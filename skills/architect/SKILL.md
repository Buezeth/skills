...
- **(Optional)** list installed skills dirs for availability only (`.antigravity/skills/`, `.agents/skills/`, `.claude/skills/`, `skills/`). Relevance is decided by AGENTS.md plus the feature, not name matching.
